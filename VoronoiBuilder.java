...
public class VoronoiBuilder {
  ...
  public VoronoiDiagram merge(
    VoronoiDiagram left_diagram, 
    VoronoiDiagram right_diagram
  ) {
    Debug.log("Merging");  
    ...
    Pair<Integer, Integer> lcs = lowest_common_support(
      left_diagram.getConvexHull(), 
      right_diagram.getConvexHull()
    );
